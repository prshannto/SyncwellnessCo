        ...
        <div className="mt-14 grid gap-8 lg:grid-cols-3">
          {featured && (
            <motion.article
              ...
              viewport={{ once: true }}
              className="relative flex flex-col rounded-3xl border-2 border-charcoal bg-gradient-to-br from-charcoal to-espresso p-8 text-white shadow-xl lg:col-span-1 lg:row-span-2"
            >
              <Badge className="mb-4 w-fit border-white/30 bg-white/20 text-white">
              ...
              <p className="mt-4 flex-1 leading-relaxed text-sage-50/90">
              ...
              <Button
                ...
                variant="secondary"
                size="lg"
                className="mt-8 bg-cream text-sage-800 hover:bg-beige-100"
              >
          ...
          <div className="flex flex-col gap-8 lg:col-span-2">
            {others.map((program, index) => (
              <motion.article
                ...
                className="flex flex-col rounded-2xl border border-beige-200 bg-cream p-8 transition-shadow hover:shadow-lg sm:flex-row sm:gap-8"
              >
                <div className="flex-1">
                  <h3 className="font-display text-xl font-semibold text-sage-900 sm:text-2xl">
                    {program.name}
                  </h3>
                  <p className="mt-1 text-sm font-medium text-sage-500">
                    {program.duration}
                  </p>
                  <p className="mt-3 text-sage-600">{program.description}</p>
